...
export class ProjectTaskController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new project task with the provided project, annotator, and files. The manager (assignedBy) is automatically set from JWT.',
  })
  @ApiResponse({
  ...
  @ApiOperation({
    summary:
      'For managers to get all project tasks with pagination and filters',
    description:
      'Retrieves all project tasks with optional filters for projectId, status, assignedByUserId, and assignedToUserId. Manager role only.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all project tasks assigned to the currently authenticated user with optional filters for projectId, status, and assignedByUserId. Available for annotator and reviewer roles.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  async getCurrentUserTasks(
    ...
    return this.projectTaskService.FindPaginatedForUser(
      req.accountInfo.sub,
      query,
      false,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific project task by its ID. Available for managers, annotators, and reviewers.',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiResponse({
    status: HttpStatus.UNAUTHORIZED,
    description:
      'Unauthorized - Manager, Annotator, or Reviewer role required.',
  })
  async getById(
    @Param('id') id: string,
  ...
  @ApiOperation({
    ...
    description:
      'Updates a project task by ID. Can update annotator user, add files, or remove files. All fields are optional. Only admins and managers can patch project tasks.',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiOperation({
    ...
    description:
      'Soft deletes a project task by setting the deletedAt timestamp. Only admins and managers can delete project tasks.',
  })
  @ApiResponse({
    status: HttpStatus.OK,
